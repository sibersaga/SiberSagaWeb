      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-white rounded-[32px] overflow-hidden border border-slate-100 shadow-xl shadow-slate-200/50 relative p-8 md:p-12 lg:p-14 flex flex-col lg:flex-row gap-8 items-center">
          ...
          <div className="flex-1 min-w-0 z-10">
            ...
            <span className="block text-[#64748B] font-bold text-[11px] uppercase tracking-[0.2em] mb-2 pl-0.5">
              SDN 3 PURWOSARI WONOGIRI
            </span>
            <h1 className="text-brand-navy text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.1] tracking-tight mb-5">
              Sekolah yang <span className="text-brand-sky">Unggul</span>,<br />
              Berkarakter & Berprestasi
            </h1>
            <p className="text-[#64748B] text-sm md:text-base leading-relaxed max-w-xl mb-8 font-normal">
              Selamat datang di portal resmi SDN 3 Purwosari Wonogiri. Kami berkomitmen menyelenggarakan pendidikan bermutu tinggi, ramah anak, dan berbasis nilai-nilai luhur Pancasila demi masa depan gemilang anak bangsa.
            </p>
                ...
                errorFallback={
                  <div className="relative w-full h-full min-h-[300px]">
                    ...
                    <div className="absolute bottom-5 left-5 right-5 text-white">
                      <span className="text-[9px] font-bold text-[#FBBF24] uppercase tracking-wider">Kampus Hijau Purwosari</span>
                      <h3 className="font-bold text-sm md:text-base mt-0.5">Asri, Bersih, dan Terakreditasi A</h3>
                    </div>
                  </div>
                }
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="bg-white border border-slate-100 shadow-md p-6 rounded-[24px] flex items-start gap-4 hover:shadow-lg transition">
            ...
            <div>
              <h3 className="font-bold text-sm text-brand-navy">Pendidikan Karakter</h3>
              <p className="text-xs text-[#64748B] mt-1.5 leading-relaxed">Menanamkan budi pekerti jujur, religius, gotong royong.</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-100 shadow-md p-6 rounded-[24px] flex items-start gap-4 hover:shadow-lg transition">
            ...
            <div>
              <h3 className="font-bold text-sm text-brand-navy">Guru Berkompetensi</h3>
              <p className="text-xs text-[#64748B] mt-1.5 leading-relaxed">Dibimbing oleh tenaga pengajar profesional dan berdedikasi tinggi.</p>
            </div>
          </div>
          ...
          <div className="bg-[#FBBF24] shadow-md shadow-yellow-101/50 p-6 rounded-[24px] flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-sm text-[#1E293B]">Fasilitas Lengkap</h3>
              <p className="text-xs text-[#1E293B]/80 mt-1.5 leading-relaxed">Laboratorium, perpustakaan nyaman, kebun Adiwiyata, & UKS.</p>
            </div>
          </div>
        </div>
      </div>
